 ...
 * @param {Number} count
 */
const repeat = (value, count) => value.toString().repeat(count)
 ...
 */
const replace = (value, string, replacement) => value.toString().replace(new RegExp(string, 'g'), replacement)
 ...
 * @param {String|Number} value
 */
const secretPhone = (value) => value.toString().replace(/(\d{3})(\d{4})(\d{4})/, '$1****$3')
 ...
 * @param {*} value
 */
const formatPhone = (value) => value.toString().replace(/(^\d{3}|\d{4}\B)/g, '$1-')
 ...
 * @param {String|Number} value
 */
const thousands = (value, fractionDigits = 0) => {
